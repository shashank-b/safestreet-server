...
class AutomatedPotholeEntrySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'id', 'reporter', 'win_size', 'vehicle_type',
            'latitude', 'longitude', 'classifier_output',
            'detection_time', 'classifier_intensity', 'event_speed'
        )
...
class RideDetailsEntrySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = RideDetails
        fields = (
            'id', 'reporter', 'vehicle_type',
            'start_time', 'stop_time', 'speed',
            'distance', 'pothole_count'
        )
